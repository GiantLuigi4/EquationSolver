...
public class Benchmarking {
	public static void main(String[] args) {
		...
		Equation eq = parser.parse("5*3/3*1*1*4/1/6-4/6/2");
		long solveNs = -1;
		long parseNs = -1;
		...
		for (int i = 0; i < 32; i++) {
			...
			System.out.println("parsing took " + parseNs1 + " ns, " + (System.currentTimeMillis() - start) + " ms");
			...
			System.out.println("solving took " + solveNs1 + " ns, " + (System.currentTimeMillis() - start) + " ms");
